...
namespace BD3GE
{
	...
	{
		//g_log.write("Loading mesh with " + std::to_string(mesh->mNumVertices) + " vertices and " + std::to_string(mesh->mNumFaces) + " faces...", LOG_INFORMATION);
		...
		// m_vertex_position_buffer = new GLfloat[4 * 3];
		// m_vertex_position_buffer[0] = -0.5f;
		// m_vertex_position_buffer[1] = -0.5f;
		// m_vertex_position_buffer[2] = -1.0f;
		// m_vertex_position_buffer[3] = 1.0f;

		// m_vertex_position_buffer[4] = 0.0f;
		// m_vertex_position_buffer[5] = 1.0f;
		// m_vertex_position_buffer[6] = -1.0f;
		// m_vertex_position_buffer[7] = 1.0f;

		// m_vertex_position_buffer[8] = 0.5f;
		// m_vertex_position_buffer[9] = -0.5f;
		// m_vertex_position_buffer[10] = -1.0f;
		// m_vertex_position_buffer[11] = 1.0f;

		// m_index_position_buffer = new GLuint[num_indices];
		// m_index_position_buffer[0] = 0;
		// m_index_position_buffer[1] = 1;
		// m_index_position_buffer[2] = 2;
		...
		//// for (unsigned int i = 0; i < m_num_vertices; ++i)
		//// {
		//// 	std::cout << "Vertex " << i << ": (" << m_vertex_position_buffer[4 * i] << ", " << m_vertex_position_buffer[(4 * i) + 1] << ", " << m_vertex_position_buffer[(4 * i) + 2] << ", " << m_vertex_position_buffer[(4 * i) + 3] << ")" << std::endl;
		//// }
		//// for (unsigned int i = 0; i < m_num_indices; ++i)
		//// {
		//// 	std::cout << "Index " << i << ": " << m_index_position_buffer[i] << std::endl;
		//// }
		//// std::cout << "Num vertices: " << m_num_vertices << std::endl;
