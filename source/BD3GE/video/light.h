...
namespace BD3GE {
	extern "C" class BD3GE_API Light {
		public:
			enum class TYPE {
				DIRECTIONAL,
				POINT,
	...
	extern "C" class BD3GE_API DirectionalLight : public Light {
		public:
	...
	extern "C" class BD3GE_API PointLight : public Light {
		public:
	...
	extern "C" class BD3GE_API SpotLight : public Light {
		public:
